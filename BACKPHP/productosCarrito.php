            ...
            <article class="table-responsive">
                ...
                <tbody>
                    <?php if($lista_carrito == null ){
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            <?php if ($descuento > 0) { ?>
                                <del class="no-underline-orange"><?php echo number_format($descuento, 0, '.', ','); ?>% descuento</del>
                            <?php } ?>
                        </td>
                        <td>
                        ...
                        <td>
                        <a href="#" id="eliminar" class="btn btn-danger btn-sm text-white"
                    ...
                    <tr>
                        <td colspan="3"> </td>
                        <td colspan="2"> 
                        <p class="h3" id="total"><?php echo '$' . number_format($total, 0, '.', ','); ?></p>
                        </td>
