          ...
          <article id="campos">
            <form id="loginForm" class="row no-gutters">
              <article class="col-12">
                <input class="form-control" name="email" type="email" placeholder="Ingrese su email aquí..." required />
              </article>
              <br /><br />
              <article class="col-12">
                <input class="form-control" name="pass" type="password" placeholder="Ingrese su contraseña aquí..."
                  required />
              </article>
              <br />
