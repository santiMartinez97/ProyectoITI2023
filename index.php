...
// $resultado = $menu->fetchAll(PDO::FETCH_ASSOC);
  ...
  <section id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <article class="carousel-inner" style="overflow-x: hidden">
      <article class="carousel-item active">
        <img src="img/VIANDASSS.jpg" style="max-width: 100%" class="d-block w-100" alt="..." />
  ...
  <section>
    ...
    <article class="section-articles">
      <article id="carouselWeeklyCards" class="carousel carousel-cards" data-bs-ride="carousel">
        <article class="carousel-inner">
          <article class="carousel-item active">
            <article class="card">
              <article class="img-wrapper">
                <img src="img/menu-placeholder.png" class="d-block w-100" alt="..." />
              </article>
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselWeeklyCards" data-bs-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselWeeklyCards" data-bs-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
          <span class="visually-hidden">Next</span>
        </button>
      </article>
  ...
  <section>
    ...
    <article class="section-articles">
      <article id="carouselNewCards" class="carousel carousel-cards" data-bs-ride="carousel">
        <article class="carousel-inner">
          <article class="carousel-item active">
            <article class="card">
              <article class="img-wrapper">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselNewCards" data-bs-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselNewCards" data-bs-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"></span>
          <span class="visually-hidden">Next</span>
        </button>
      </article>
