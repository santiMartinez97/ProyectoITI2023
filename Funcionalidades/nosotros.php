    ...
    <article id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <article class="carousel-inner">
        <article class="carousel-item active">
          <img src="../img/distribucion_cocina_rte-thegem-blog-default.jpg" class="d-block w-100" id="imagenSobreN1"
            alt="...">
    ...
    <article class="us">
      <article class="us-paragraph">
        ...
        <p class="parrafo-text"> Creemos fervientemente
          que cuidar de uno mismo no debe ser una tarea monótona, sino una celebración de sabores auténticos y
          nutritivos.</p>
      </article>
