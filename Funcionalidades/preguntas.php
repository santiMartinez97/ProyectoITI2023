      ...
      <article class="container-faq">
        ...
        <article class="item-faq">
          ...
          <article class="respuesta">
            <p>Para realizar tu compra simplemente debes completar el formulario de nuestra página.Una vez hecho esto,
              tiene que esperar 24hs que le llegue la confirmacion por correo que su cuenta a sido activada
              correctamente.<span>R</span></p>
          </article>
        </article>
        ...
        <article class="item-faq">
          ...
          <article class="respuesta">
            <p>Las viandas saludables te permiten ahorrar tiempo en la preparación de comidas, mientras te aseguras de
              consumir alimentos que respaldan tu bienestar.<span>R</span></p>
          </article>
        </article>
        ...
        <article class="item-faq">
          ...
          <article class="respuesta">
            <p>Las viandas saludables son comidas preparadas con ingredientes frescos y nutritivos, diseñadas para
              ofrecer una opción conveniente y equilibrada para quienes buscan cuidar su alimentación.<span>R</span></p>
          </article>
        </article>
        ...
        <article class="item-faq">
          ...
          <article class="respuesta">
            <p>Puedes hacer un pedido a través de nuestro sitio web o plataforma en línea. Aceptamos pagos con tarjeta
              de crédito y otros métodos seguros en línea.<span>R</span></p>
          </article>
        </article>
